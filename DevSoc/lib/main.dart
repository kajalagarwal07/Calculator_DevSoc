            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    calButtons('AC', Colors.white, 80, Colors.black54!),
                    calButtons('Del', Colors.white, 80, Colors.black54!),
                    calButtons('%', Colors.white, 80, Colors.black54!),
                    calButtons('÷', Colors.white, 80, Colors.black38!),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    calButtons('7', Colors.white, 80, Colors.blue!),
                    calButtons('8', Colors.white, 80, Colors.blue!),
                    calButtons('9', Colors.white, 80, Colors.blue!),
                    calButtons('×', Colors.white, 80, Colors.black38!),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    calButtons('4', Colors.white, 80, Colors.blue!),
                    calButtons('5', Colors.white, 80, Colors.blue!),
                    calButtons('6', Colors.white, 80, Colors.blue!),
                    calButtons('-', Colors.white, 80, Colors.black38!),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    calButtons('1', Colors.white, 80, Colors.blue!),
                    calButtons('2', Colors.white, 80, Colors.blue!),
                    calButtons('3', Colors.white, 80, Colors.blue!),
                    calButtons('+', Colors.white, 80, Colors.black38!),
                ...
                Row(
                  ...
                  children: [
                    calButtons('.', Colors.white, 80, Colors.black54!),
                    calButtons('0', Colors.white, 80, Colors.blue!),
                    calButtons('=', Colors.white, 80, Colors.black38!),
